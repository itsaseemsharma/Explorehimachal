    ...
    def getDestinationsByCity(self, cityname):
        ...
        for i in data[1]:
           ...
           # description.append(self.getDescription(i.blockData))
            description.append(i.blockData)
    ...
    def getDescription(self, d):
        ...
        while count < 2:
            if(s[i] == "."):
                count += 1
            i += 1
        print("s____________________________________________",s)
        return s[:i]

    def addcontacts(self, name, email, phone, person, trekname, message):
        status = self.db.addcontacts(name, email, phone, person, trekname, message)
